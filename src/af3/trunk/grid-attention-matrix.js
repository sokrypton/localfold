 ...
 * staging is in the loop, not in K. AF2's `src/kernels/attention-matrix.js`
 * measures 1.69x on exactly this shape.
 *
 * 🔴 WRITTEN BESIDE AF2'S KERNEL RATHER THAN SHARED WITH IT, WHICH IS THE SAME
 * CALL src/af3/trunk/grid-attention-webgpu.js ALREADY MADE AND RECORDED. AF2's takes
...
} from "../../kernels/attention-geometry.js";
...
export function createGridAttendMatrixShader(shape, store4 = {}, geometry) {
  ...
  // AF2's flash attention; see `prefetch` in src/kernels/matrix-linear.js.
  //
