 ...
 * src/af3/trunk/pair-track-gpu.js.
 */
...
export class Af3MsaStackGpu {
  ...
  async run(state, blocks, dialect, options = {}) {
    ...
    // width loads either bundle without complaint - see src/af3/weights/weights.js.
    ...
    if (!(pairChannels > 0)) {
      throw new Error("MSA blocks carry no pairChannels; they are built by "
        + "src/af3/weights/weights.js, which derives it from the weights");
    }
  ...
  async #encodeBlock(context) {
    ...
    // src/af3/trunk/pairformer-block-webgpu.js for why residency is a trade the
    ...
    // The four the device can pack itself; see src/af3/weights/pair-track-device-weights.js
    ...
    // build it. See src/af3/weights/pair-track-device-weights.js.
