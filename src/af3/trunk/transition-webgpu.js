 ...
 * and returns a plausible tensor. See src/af3/trunk/triangle-webgpu.js.
 *
...
export function createTransitionShader(shape, offsets, epsilon, variance) {
  ...
  // it is the same change as src/kernels/triangle/shaders.js's two projections, where
  ...
  // key and value in src/kernels/attention.js, where narrowing them to f16
  ...
  // two-pass one. See the note in src/kernels/triangle/shaders.js.
...
// src/kernels/triangle/shaders.js's input normalisation.
 ...
 *
 * The width rule is real and is measured in src/af3/trunk/transition-webgpu.js's
