 ...
 * is.
 *
 * With the decoder able to reshape (see src/weights/quantised-upload.js), the
 ...
 */
import { SOURCES, bindable } from "../../weights/weight-sources.js";
...
import { writeInto } from "../../weights/float16.js";
...
export async function residentTriangleOnDevice(device, options) {
  ...
  return residentWeightBufferFilled(device, triangle, label, bytes,
    async (buffer) => {
      ...
      // Not awaited; see src/af3/weights/device-weights.js for why.
