...
async function encodeTriangleMultiplication(
  ...
  // vector - and src/kernels/triangle/ is ONE module: the shaders AF3 moved onto the
  ...
  // finite, plausible tensor. See src/kernels/triangle/weights.js.
  ...
  // 🔴 ROWS OVER y AND z, WHICH src/af2/multimer/block.js HAS DONE ALL ALONG AND
 ...
 * writes visible to the next. src/af2/evoformer/stack.js does exactly this between
 * blocks and says so; this does it between sub-layers.
 *
 * src/af3/trunk/pair-track-gpu.js reached the same conclusion from the other side and
